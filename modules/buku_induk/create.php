<?php
// emadrasah/modules/buku_induk/create.php
...
<form action="<?php echo base_url('modules/buku_induk/store.php'); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_input(); ?>
    <!-- Tabs Navigation -->
        ...
        <div class="tab-pane fade" id="tab-tinggal">
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <input type="text" name="alamat" class="form-control" placeholder="Jl. Raya No...">
                </div>
                <div class="col-md-2">
        ...
        <div class="tab-pane fade" id="tab-pendidikan">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nama_madrasah_asal" class="form-control">
                </div>
                <div class="col-md-6">
